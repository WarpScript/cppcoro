...
namespace cppcoro
{
	...
	namespace detail
	{
		...
		private:
			...
			coro::coroutine_handle<> m_consumerCoroutine;
		...
		public:
			...
			async_generator_yield_operation(coro::coroutine_handle<> consumer) noexcept
				: m_consumer(consumer)
			{}
			...
			await_suspend([[maybe_unused]] coro::coroutine_handle<> producer) noexcept
			{
				return m_consumer;
			}
		...
		private:
			...
			coro::coroutine_handle<> m_consumer;
		...
		protected:
			...
			async_generator_advance_operation(
				...
				coro::coroutine_handle<> producerCoroutine) noexcept
		...
		public:
			...
			coro::coroutine_handle<>
				await_suspend(coro::coroutine_handle<> consumerCoroutine) noexcept
			{
		...
		protected:
			...
			coro::coroutine_handle<> m_producerCoroutine;
	...
	public:
		...
		explicit async_generator(promise_type& promise) noexcept
			: m_coroutine(coro::coroutine_handle<promise_type>::from_promise(promise))
		{}
	...
	private:
		...
		coro::coroutine_handle<promise_type> m_coroutine;
	...
	namespace detail
	{
		...
		public:
			...
			bool await_suspend(coro::coroutine_handle<> producer) noexcept;
		...
		inline bool async_generator_yield_operation::await_suspend(
			coro::coroutine_handle<> producer) noexcept
		{
		...
		public:
			...
			bool await_suspend(coro::coroutine_handle<> consumerCoroutine) noexcept
			{
				m_promise->m_consumerCoroutine = consumerCoroutine;
