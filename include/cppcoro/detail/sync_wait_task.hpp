...
namespace cppcoro
{
	namespace detail
	{
		...
		{
			using coroutine_handle_t = coro::coroutine_handle<sync_wait_task_promise<RESULT>>;
		...
		{
			using coroutine_handle_t = coro::coroutine_handle<sync_wait_task_promise<void>>;
