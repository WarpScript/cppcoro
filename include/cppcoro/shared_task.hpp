...
namespace cppcoro
{
	...
	namespace detail
	{
		...
		public:
			...
			bool try_await(shared_task_waiter* waiter, coro::coroutine_handle<> coroutine)
			{
	...
	private:
		...
		struct awaitable_base
		{
			...
			awaitable_base(coro::coroutine_handle<promise_type> coroutine) noexcept
			...
			bool await_suspend(coro::coroutine_handle<> awaiter) noexcept
			{
	...
	public:
		...
		explicit shared_task(coro::coroutine_handle<promise_type> coroutine)
			: m_coroutine(coroutine)
		{
	...
	namespace detail
	{
		...
		shared_task<T> shared_task_promise<T>::get_return_object() noexcept
		{
			return shared_task<T>{
				coro::coroutine_handle<shared_task_promise>::from_promise(*this)
			};
		}
